...
public class Sessions extends JFrame {
	...
	public Sessions() {
		...
		txtLecturerNameSession.setModel(new DefaultComboBoxModel(new String[] {""}));
		...
		txtSubjectNameSession.setModel(new DefaultComboBoxModel(new String[] {""}));
		...
		txtTagSession.setModel(new DefaultComboBoxModel(new String[] {""}));
		txtTagSession.setBounds(209, 142, 331, 19);
		panel_1.add(txtTagSession);
		
		txtGroupIDSession = new JComboBox();
		txtGroupIDSession.setModel(new DefaultComboBoxModel(new String[] {""}));
		...
		txtTagSession2.setModel(new DefaultComboBoxModel(new String[] {""}));
		txtTagSession2.setBounds(172, 206, 256, 21);
		panel_2.add(txtTagSession2);
		
		txtGroupIDSession2 = new JComboBox();
		txtGroupIDSession2.setModel(new DefaultComboBoxModel(new String[] {""}));
		...
		SessioncomboBox.setModel(new DefaultComboBoxModel(new String[] {""}));
