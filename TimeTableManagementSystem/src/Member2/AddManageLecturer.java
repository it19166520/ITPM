...
public class AddManageLecturer extends JFrame {
	...
	public AddManageLecturer() {
		...
		lblNewLabel_37 = new JLabel("Type  11:00-16:00  (from 00:00 to 23:59)  OR  type  \" free\"  for free days,  and Click \"Enter\"button.");
		lblNewLabel_37.setFont(new Font("Tahoma", Font.BOLD, 9));
		lblNewLabel_37.setForeground(new Color(0, 128, 0));
		lblNewLabel_37.setBounds(43, 36, 509, 13);
		...
		JLabel lblNewLabel_37_1 = new JLabel("Ex:");
		lblNewLabel_37_1.setForeground(new Color(0, 128, 0));
		lblNewLabel_37_1.setFont(new Font("Tahoma", Font.BOLD, 9));
		lblNewLabel_37_1.setBounds(43, 22, 509, 13);
		panel_9.add(lblNewLabel_37_1);
	...
	if(!(txtLecturerName.getText().trim().isEmpty()) && txtFaculty.getSelectedIndex() != -1 && txtDepartment.getSelectedIndex() != -1 && txtCampus.getSelectedIndex() != -1 && txtBuilding.getSelectedIndex() != -1 && !(txtLecturerID.getText().trim().isEmpty()) && txtLevel.getSelectedIndex() != -1 && !(txtRank.getText().trim().isEmpty()) && !(txtMonday.getText().trim().isEmpty()) && !(txtTuesday.getText().trim().isEmpty()) && !(txtWednesday.getText().trim().isEmpty()) && !(txtThursday.getText().trim().isEmpty()) && !(txtFriday.getText().trim().isEmpty()) && !(txtSatarday.getText().trim().isEmpty()) && !(txtSunday.getText().trim().isEmpty())) {						
		...
		panel_16.setBounds(20, 11, 525, 265);
		...
		JLabel lblNewLabel_37_2 = new JLabel("Type  11:00-16:00  (from 00:00 to 23:59)  OR  type  \" free\"  for free days,  and Click \"Enter\"button.");
		lblNewLabel_37_2.setForeground(new Color(0, 128, 0));
		lblNewLabel_37_2.setFont(new Font("Tahoma", Font.BOLD, 9));
		lblNewLabel_37_2.setBounds(41, 11, 509, 13);
		panel_16.add(lblNewLabel_37_2);
