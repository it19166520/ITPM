...
public class MainAddRoom extends JFrame {
	...
	private JButton btnAddNormalSession;
	...
	public MainAddRoom() {
		...
		panel_1.setBounds(617, 183, 640, 435);
		...
		addconssessions.setBounds(128, 83, 389, 44);
		...
		addparsession.setBounds(128, 11, 389, 44);
		...
		addnonoverlappingrooms.setBounds(128, 163, 389, 44);
		...
		viewallbtn.setBounds(128, 299, 389, 44);
		...
		backbtn.setBounds(488, 392, 142, 32);
		panel_1.add(backbtn);
		
		btnAddNormalSession = new JButton("Add Normal Session Rooms");
		btnAddNormalSession.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				normalSessions dis = new normalSessions();
				dis.show();
				dispose();
				
			}
		});
		btnAddNormalSession.setForeground(Color.WHITE);
		btnAddNormalSession.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 16));
		btnAddNormalSession.setBackground(new Color(0, 0, 139));
		btnAddNormalSession.setBounds(128, 232, 389, 44);
		panel_1.add(btnAddNormalSession);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon(MainAddRoom.class.getResource("/Images/back.png")));
